...
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (14, 'Francesco', 'Gallo', 'francesco.gallo@gmail.com', '../../images/Avatars/8.jpg', 'Sono appassionato delle lingue e delle culture che le accompagnano. Il francese è il mio primo amore, e mi piace trasmettere non solo le sue regole grammaticali ma anche la bellezza della sua letteratura e storia. Cerco di creare un ambiente di apprendimento dinamico e interattivo, dove ogni studente possa sviluppare le proprie competenze linguistiche e scoprire il piacere di comunicare in una nuova lingua.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (15, 'Martina', 'Leone', 'martina.leone@gmail.com', '../../images/Avatars/2.jpg', 'Amo la lingua italiana in tutte le sue sfumature, dalla letteratura classica alla scrittura contemporanea. Credo che l''apprendimento dell''italiano non si limiti alla grammatica, ma sia un viaggio attraverso la cultura, la storia e l''arte del nostro paese. Nelle mie lezioni, cerco di ispirare gli studenti a esplorare la ricchezza della nostra lingua, aiutandoli a esprimersi con sicurezza e creatività, sia oralmente che per iscritto.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (16, 'Alessandro', 'Moretti', 'alessandro.moretti@gmail.com', '../../images/Avatars/10.jpg', 'La recitazione e la storia del teatro sono la mia più grande passione. Credo nel potere trasformativo del teatro, sia come forma d''arte che come strumento di crescita personale. Nelle mie lezioni, esploriamo insieme le tecniche recitative e i grandi autori del passato, immergendoci nelle opere che hanno plasmato la storia del teatro. Il mio obiettivo è aiutare gli studenti a trovare la propria voce espressiva e a comprendere l''importanza del teatro come specchio della società.');
...
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (20, 'Federica', 'Sanna', 'federica.sanna@gmail.com', '../../images/Avatars/3.jpg', 'Sono interessata a come le persone interagiscono tra loro e come le società si evolvono. Mi piace creare un ambiente di apprendimento collaborativo, dove gli studenti possano esplorare e discutere insieme i vari temi sociali.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (21, 'Laura', 'Marini', 'laura.marini@gmail.com', '../../images/Avatars/3.jpg', 'La lingua spagnola è per me una porta d''accesso a un mondo ricco di culture vibranti e tradizioni affascinanti. Amo insegnare lo spagnolo attraverso un approccio immersivo, che combina grammatica, conversazione e cultura. Il mio obiettivo è rendere l''apprendimento piacevole e stimolante, aiutando gli studenti a sentirsi a proprio agio nell''esprimersi e a scoprire la bellezza della lingua e delle culture ispaniche.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (22, 'Anna', 'Vitali', 'anna.vitali@gmail.com', '../../images/Avatars/2.jpg', 'Mi piace esplorare le grandi domande dell universo e stimolare la curiosità degli studenti. Credo che la fisica sia non solo una scienza, ma anche un modo per riflettere su chi siamo e sul mondo in cui viviamo.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (23, 'Simone', 'Orlando', 'simone.orlando@gmail.com', '../../images/Avatars/4.jpg', 'Mi dedico al benessere degli studenti, creando un ambiente inclusivo e stimolante. Ritengo importante che ogni studente si senta ascoltato e valorizzato, e cerco di trasmettere questo nelle mie lezioni.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (24, 'Giovanni', 'Marchetti', 'giovanni.marchetti@gmail.com', '../../images/Avatars/6.jpg', 'La musica è il mio linguaggio preferito. Amo esplorare nuove composizioni e suoni, e cerco di trasmettere questa passione agli studenti, incoraggiandoli a esprimere la loro creatività attraverso la musica.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (25, 'Antonio', 'Romano', 'antonio.romano@gmail.com', '../../images/Avatars/4.jpg', 'Sono un appassionato delle lingue, in particolare dell''inglese e del francese, e amo esplorare con gli studenti le connessioni tra queste due culture ricche e diverse. Nelle mie lezioni, mi concentro sullo sviluppo delle competenze linguistiche attraverso attività pratiche e interattive, puntando non solo alla padronanza grammaticale, ma anche alla comprensione culturale. Il mio obiettivo è aiutare gli studenti a comunicare con sicurezza e a esplorare il mondo attraverso nuove lingue.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (26, 'Aurora', 'Bellini', 'aurora.bellini@gmail.com', '../../images/Avatars/2.jpg', 'Amo il mare e tutto ciò che lo riguarda. Cerco di trasmettere questa passione nelle mie lezioni, coinvolgendo gli studenti in discussioni e progetti che esplorano le meraviglie dell ambiente marino e la sua conservazione.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (27, 'Luca', 'Santini', 'luca.santini@gmail.com', '../../images/Avatars/10.jpg', 'Sono profondamente interessato a come le società umane si sviluppano e interagiscono. Insegnare antropologia e scienze sociali mi permette di condividere questa curiosità con gli studenti, esplorando insieme le diverse culture e strutture sociali che definiscono l''umanità. Il mio approccio è analitico e riflessivo, incoraggiando gli studenti a osservare il mondo con occhi critici e a comprendere le dinamiche che modellano le nostre esperienze sociali quotidiane.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (28, 'Marta', 'Ferraro', 'marta.ferraro@gmail.com', '../../images/Avatars/2.jpg', 'Il volo e lo spazio sono le mie grandi passioni. Mi piace condividere questa meraviglia con gli studenti, coinvolgendoli in progetti che esplorano le sfide e le opportunità del volo e della tecnologia aerospaziale.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (29, 'Giada', 'Rossetti', 'giada.rossetti@gmail.com', '../../images/Avatars/9.jpg', 'Sono profondamente curiosa e amo esplorare il mondo che ci circonda. Cerco di trasmettere questa curiosità agli studenti, incoraggiandoli a fare domande e a scoprire nuove realtà attraverso la ricerca e lesplorazione.');
INSERT INTO Tutor (FK_UTENTE, NOME, COGNOME, MAIL, PATH_IMG, INFO) VALUES (30, 'Sabrina', 'Morelli', 'sabrina.morelli@gmail.com', '../../images/Avatars/9.jpg', 'Il cinese è una lingua affascinante che apre le porte a una cultura millenaria ricca di storia e tradizione. Amo condividere con i miei studenti non solo la complessità della lingua, ma anche la bellezza della calligrafia, dei caratteri e della filosofia cinese. Le mie lezioni sono strutturate per rendere l''apprendimento del cinese accessibile e stimolante, aiutando gli studenti a sviluppare competenze linguistiche solide e a immergersi nella cultura cinese con curiosità e rispetto.');
